...
@section('title') تعديل  جامعة  @endsection
@section('content')
        ...
        <div class="col-md-12">
            ...
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title">تعديل  جامعة  </h3>
                </div>
                {!! Form::model($university, ['route' => ['admin.universities.update', $university->id], 'method' => 'put', 'id' => 'form_add']) !!}
...
@section('breadcrumb')
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark"> تعديل  جامعة </h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item active">تعديل  جامعة  </li>
