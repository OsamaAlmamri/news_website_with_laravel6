...
@section('title') اضافة صفحة ثابتة  @endsection
        ...
        <div class="col-md-12">
            ...
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title">اضافة صفحة ثابتة</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                {!! Form::open(['route' => 'admin.pages.static.store', 'method' => 'post', 'role' => 'form', 'id' => 'form_add']) !!}
