    ...
    <div class="col-md-12">
        ...
        <div class="card card-primary">
            <div class="card-header">
                <h3 class="card-title">تعديل صفحة قسم {{ $page->category->name }}</h3>
            </div>
            {!! Form::model($page, ['route' => ['admin.pages.categories.update', $page->id], 'method' => 'put', 'role' => 'form', 'id' => 'form_add']) !!}
            <div class="card-body">
            ...
            <div class="all-modules-container row">
                <div class="clearfix border-bottom">
                    ...
                    <div class="text-center p-2">
                        <h5 id="model-title">أقسام البلوكات</h5>
                    </div>
                </div>
