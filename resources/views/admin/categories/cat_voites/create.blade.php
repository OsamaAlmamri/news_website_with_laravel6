...
@section('title')  اضافة تصويت للصفحة   @endsection
        ...
        <div class="col-md-12">
            ...
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title">اضافة تصويت  للصفحة </h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->

                {!! Form::open(['role' => 'form', 'id' => 'form_add', 'method' => 'post', 'route' => 'admin.categories_voit.store', 'files' => true]) !!}
